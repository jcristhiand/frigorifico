...
import '../pdf2_view_page.dart';
import 'package:intl/intl.dart';
import '../pages/conservacion2_page.dart';
import '../pages/etiqueta2_page.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Image.asset('assets/milan.png', width: 120, fit: BoxFit.contain),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text("Ver información del Milan"),
                  ),
                ],
              ),
            ),
